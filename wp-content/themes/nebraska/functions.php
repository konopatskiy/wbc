...
get_template_part( '/functions/theme-menuwalker');
get_template_part( '/functions/theme-functions');
get_template_part( '/functions/theme-shortcodes');
get_template_part( '/functions/theme-post-formats');
get_template_part( '/functions/theme-slider-shortcodes');
get_template_part( '/functions/pagecreator-functions');
get_template_part( '/lambda/lambda.register.widgets');
...
#-----------------------------------------------------------------
get_template_part( '/functions/theme-layout-functions');
get_template_part( '/functions/theme-custom-css');
get_template_part( '/functions/theme-java-functions');
