...
if( !function_exists( 'lambda_portfolio_columns' ) ) {
	...
	if((isset($portfolio['activate_portfolio']) && $portfolio['activate_portfolio'] == 'on') || $pagebuilder = true) { ?>
			...
			<section class="list_portfolio clearfix<?php echo ($count == 1) ? ' padding-top' : ''; echo ($lastborder) ? ' last-border' : ''; ?>">
			...
			<?php if(isset($portfolio['portfolio_headline']) && !empty($portfolio['portfolio_headline'])) :?>				
                 ...
                 <div class="title-wrap clearfix">
                    ...
                    <?php if( isset($portfolio['portfolio_link']) && !empty($portfolio['portfolio_link'])) : ?>
                    	...
                    	<span class="home-title-link"><a href="<?php echo $portfolio['portfolio_link'];?>"><?php echo $portfolio['portfolio_link_text']; ?></a></span>
...
if( !function_exists( 'render_service_box' ) ) {
	...
	function render_service_box($metadata, $servicegrid='one_fourth', $last='', $home = false, $colnumber=1) { 				
				...
				<?php } ?>							
                    ...
                    <a style="color:<?php echo $metadata['col_box_textcolor']; ?>" data-textcolor="<?php echo $metadata['col_box_textcolor']; ?>" data-texthovercolor="<?php echo $metadata['col_box_texthovercolor']; ?>" href="<?php echo lambda_translate_meta($metadata['col_box_link']); ?>" target="_self">
                    <article class="service-box" style="background:<?php echo $metadata['col_box_bgcolor']; ?>;" data-bgcolor="<?php echo $metadata['col_box_bgcolor']; ?>" data-hovercolor="<?php echo $metadata['col_box_hovercolor']; ?>">
                                ...
                                <figure class="service-box-icon">
                                    <img src="<?php echo $metadata['col_box_icon']; ?>" alt="<?php echo (!empty($metadata['col_box_alt']) ) ? $metadata['col_box_alt'] : $filename; ?>" />
                                </figure>
...
if( !function_exists( 'render_testimonial_carousel' ) ) {
	function render_testimonial_carousel($metadata, $testimonials='', $ID=1, $type) {
		...
		if(isset($metadata['testimonial_headline'])) : ?>
            ...
            <div class="title-wrap clearfix">
            	<h3 class="home-title"><span><?php echo lambda_translate_meta($metadata['testimonial_headline']); ?></span></h3>
		...
		<?php endif; ?>
         ...
         <?php if(isset($metadata['box_type'])) : ?>
                  ...
                  <div class="title-wrap clearfix">      
                        <h3 class="home-title"><span><?php echo (isset($metadata['box_title']) && !empty($metadata['box_title'])) ? $metadata['box_title'] : ''; ?></span></h3>
						...
						if(is_array($testimonials)) {
							...
							<li style="margin-bottom:0px !important; margin-left:0px !important; padding:0 1px;">
								...
								<figure class="testimonial-photo">
									...
									<img alt="<?php _e('customer photo', UT_THEME_INITIAL); ?>" class="testimonial-img" src="<?php echo $authorimage; ?>">
...
if( !function_exists( 'render_lambda_blog' ) ) {
	function render_lambda_blog($metadata, $homeblog = false) {
		...
		<section class="post <?php echo $removebottom; ?> <?php echo $bloggrid; ?> <?php if($z%$gridcount[$bloggrid]==0) { echo 'last'; } ?>" id="post-<?php the_ID(); ?>">
