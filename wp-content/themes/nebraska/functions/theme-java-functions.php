	...
	<div class="elastic-video-wrapper">
		...
		<script type="text/javascript">
				...
				var attributes = {};
					...
					function embedSWF(){
					swfobject.embedSWF("<?php echo get_template_directory_uri(); ?>/javascripts/NonverBlaster.swf", "videoPlayer_<?php echo $postID; ?>", "<?php echo $videowidth; ?>", "320", "9", "<?php echo get_template_directory_uri(); ?>/javascripts/expressinstall.swf", flashvars, params, attributes);
				}
				embedSWF();
