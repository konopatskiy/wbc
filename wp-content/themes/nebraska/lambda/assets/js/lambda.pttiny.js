...
/*-----------------------------------------------------------------------------------*/
	...
	sortable: function(){
		...
		$('#wpa_loop-nebraska_verticaltabs').sortable({
			//cancel: ':input,button,.customEditor', // exclude TinyMCE area from the sort handle
		...
		$('#wpa_loop-nebraska_home_verticaltabs').sortable({
			//cancel: ':input,button,.customEditor', // exclude TinyMCE area from the sort handle
			handle: '.testimonial_item_name',
			placeholder: "verticaltabs_highlight",
			opacity: 0.5,
		...
		$('#wpa_loop-nebraska_home_items').sortable({
		...
		$('#wpa_loop-nebraska_home_testimonials').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_testimonial_items').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_team_member').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_contact_form_fields').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_faq_items').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_project_atts').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_client_images').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
		...
		$('#wpa_loop-nebraska_portfolio_images').sortable({
			opacity: 0.5,
			tolerance: 'pointer',
			start: function(event, ui) { // turn TinyMCE off while sorting (if not, it won't work when resorted)
                ui.placeholder.height(ui.item.height());
