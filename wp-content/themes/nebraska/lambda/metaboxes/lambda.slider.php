...
<div class="slider_type_background ten columns">
	...
	<div class="lambda-opttitle">
		<div class="lambda-opttitle-pad">
			<i class="icon-align-justify icon-black"></i> <?php _e( 'Hide Teaser / Page Title?', UT_THEME_NAME ); ?>
            <br /><span>(<?php _e( 'This will hide the page title, but the title is still visible for search engines!', UT_THEME_NAME ); ?>)</span>
		</div>
	</div>
	...
	<div class="lambda-settings-pad">
        ...
        <p>
		<label class="metalabel"><?php _e( 'Alternative Title', UT_THEME_NAME ); ?></label>
		<?php $mb->the_field('teaser_text'); ?>
		<textarea name="<?php $mb->the_name(); ?>" rows="8" cols="75" class="lambdatextarea"><?php $mb->the_value(); ?></textarea>
		<br /><span class="info badge badge-info">(<?php _e( 'Display an individual Page Title', UT_THEME_NAME ); ?>)</span>
		</p>
        
		<p>
		<label class="metalabel"><?php _e( 'Teaser Content', UT_THEME_NAME ); ?></label>
		<?php $mb->the_field('teaser_content'); ?>
		<textarea name="<?php $mb->the_name(); ?>" rows="8" cols="75" class="lambdatextarea"><?php $mb->the_value(); ?></textarea>
		<br /><span class="info badge badge-info">(<?php _e( 'Display an inidividual text beneath the page title', UT_THEME_NAME ); ?>)</span>
		</p>
