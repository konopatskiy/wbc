...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
            ...
            <div class="clear"></div>
				...
				$related = substr($related,0,-1);
																		
				query_posts('post_type='.UT_PORTFOLIO_SLUG.'&posts_per_page=4&paged='.$paged.'&project_types='.$related);
                ...
                <section id="related-projects">
                    ...
                    <div class="title-wrap clearfix">
                   		...
                   		<h3 class="home-title"><span><?php _e('Related Projects', UT_THEME_INITIAL); ?></span></h3>
