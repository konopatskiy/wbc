	...
	<div class="post-image">	
		...
		?>
            ...
            <a title="<?php echo get_the_title(); ?>" data-rel="prettyPhoto" href="<?php echo $popup; ?>">
            	<div class="hover-overlay"><span class="circle-hover"><img src="<?php echo get_template_directory_uri(); ?>/images/lens-icon.png" alt="<?php _e('zoom icon', UT_THEME_INITIAL); ?>" /></span></div>
            </a>
