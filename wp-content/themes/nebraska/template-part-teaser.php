...
if( is_search() ) { $hideteaser = 'teaseron'; }
	...
	<div class="container">
        ...
        <div id="teaser-content-portfolio-single" class="sixteen columns">
            ...
            <div id="nav-portfolio" class="five columns omega navigation clearfix">
					...
					<?php if(!get_adjacent_post(false, '', false)) { echo '<div class="nav-next"><a href="'.$portfolio_first_item.'" >'.__('Next', UT_THEME_INITIAL).'</a></div>'; } ?>                    
                                        
                    <div class="nav-previous"><?php previous_post_link( '%link', _x('Previous', UT_THEME_NAME )); ?></div>
					<?php if(!get_adjacent_post(false, '', true)) { echo '<div class="nav-previous"><a href="'.$portfolio_last_item.'" >'.__('Previous', UT_THEME_INITIAL).'</a></div>'; } ?>
